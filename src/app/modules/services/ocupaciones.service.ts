...
import { CountryesxUsuario, Ocupaciones, OpcionMenu, OpcionesGenericas, OpcionesMenuUsuario, Parentesco, PerfilUsuario, PeriocidadEntrega, PresentacionMedicamentoxMedicamento, ProcesoInstaurado, ProcesosAdministrativos, ProcesosInstaurados, RangosTiempo, Reemplazos, Referente, RegimenxCountry, Reinicios, ReporteUsuario, Reportes } from '../Models/tablaMaestraOcupaciones.model';
import { environment } from 'environments/environment';
import { Observable, retry, catchError, throwError } from 'rxjs';
import { Paises } from '../Models/location.model';
import { PeriodoConvulsiones, Regimen } from '../Models/actividad.model';
...
export class OcupacionesService {
    ...
    // Consulta de registros de accion actual.
    getAllPaisesxUsuario(): Observable<Paises> {
        return this.http
            .get<Paises>(environment.baseUrl + 'PaisesxUsuario/')
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    getAllPresentacionMedicamentoxMedicamento(): Observable<PresentacionMedicamentoxMedicamento> {
        return this.http
            .get<PresentacionMedicamentoxMedicamento>(
    ...
    // Consulta de registros de accion actual.
    getAllRegimenxPais(): Observable<RegimenxCountry> {
        return this.http
            .get<RegimenxCountry>(environment.baseUrl + 'RegimenxPais/')
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    // Consulta de registros de areas con parametros
    getAllPaisesxUsuarioById(id: number): Observable<CountryesxUsuario> {
        return this.http
            .get<CountryesxUsuario>(
    ...
    getAllPeriodoConvulsionesById(id: number): Observable<PeriodoConvulsiones> {
        return this.http
            .get<PeriodoConvulsiones>(
                environment.baseUrl + 'PeriodoConvulsiones/' + id
            )
            .pipe(retry(1), catchError(this.errorHandl));
    }

    // Consulta de registros de areas con parametros
    getAllPresentacionMedicamentoxMedicamentoById(
        id: number
    ): Observable<PresentacionMedicamentoxMedicamento> {
        return this.http
            .get<PresentacionMedicamentoxMedicamento>(
                environment.baseUrl +
                    'PresentacionMedicamentoxMedicamento/' +
                    id
            )
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    // Consulta de registros de areas con parametros
    getAllProcesosAdministrativosById(
        id: number
    ): Observable<ProcesosAdministrativos> {
        return this.http
            .get<ProcesosAdministrativos>(
    ...
    // Consulta de registros de areas con parametros
    getAllRegimenxPaisById(id: number): Observable<RegimenxCountry> {
        return this.http
            .get<RegimenxCountry>(environment.baseUrl + 'RegimenxPais/' + id)
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearPaisesxUsuario(data: any): Observable<RegimenxCountry> {
        return this.http
            .post<RegimenxCountry>(
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearPresentacionMedicamentoxMedicamento(
        data: any
    ): Observable<PresentacionMedicamentoxMedicamento> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearRegimenxPais(data: any): Observable<RegimenxCountry> {
        return this.http
            .post<RegimenxCountry>(
    ...
    // Edición de registros existentes.
    updateOpcionesGenericas(
        id: number,
        data: any
    ): Observable<OpcionesGenericas> {
        return this.http
    ...
    // Edición de registros existentes.
    updateOpcionesMenuUsuario(
        id: number,
        data: any
    ): Observable<OpcionesMenuUsuario> {
        return this.http
    ...
    // Edición de registros existentes.
    updatePresentacionMedicamentoxMedicamento(
        id: number,
        data: any
    ): Observable<PresentacionMedicamentoxMedicamento> {
        return this.http
    ...
    // Edición de registros existentes.
    updateProcesoInstaurado(
        id: number,
        data: any
    ): Observable<ProcesoInstaurado> {
        return this.http
    ...
    // Edición de registros existentes.
    updatePeriocidadEntrega(
        id: number,
        data: any
    ): Observable<PeriocidadEntrega> {
        return this.http
    ...
    // Edición de registros existentes.
    updateProcesosInstaurados(
        id: number,
        data: any
    ): Observable<ProcesosInstaurados> {
        return this.http
    ...
    // Edición de registros existentes.
    updateRegimenxPais(id: number, data: any): Observable<RegimenxCountry> {
        return this.http
            .put<RegimenxCountry>(
    ...
    // Eliminar registro de la tabla ciudad
    deletePaisesxUsuarioById(id: number): Observable<RegimenxCountry> {
        return this.http
            .delete<RegimenxCountry>(
                environment.baseUrl + 'PaisesxUsuario/' + id,
                this.httpOptions
            )
            .pipe(retry(1), catchError(this.errorHandl));
    ...
    // Eliminar registro de la tabla ciudad
    deletePresentacionMedicamentoxMedicamentoById(
        id: number
    ): Observable<PresentacionMedicamentoxMedicamento> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteProcesosAdministrativosById(
        id: number
    ): Observable<ProcesosAdministrativos> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteRegimenxPaisById(id: number): Observable<RegimenxCountry> {
        return this.http
            .delete<RegimenxCountry>(
                environment.baseUrl + 'RegimenxPais/' + id,
                this.httpOptions
