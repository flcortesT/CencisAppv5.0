...
export class CaracteristicasService {
  ...
  getAllCaracteristicasVivienda(): Observable<CaracteristicasVivienda> {
    return this.http
      .get<CaracteristicasVivienda>(environment.baseUrl + 'CaracteristicasVivienda')
  ...
  getAllMaestraCaracteristicas(): Observable<MaestraCaracteristicas> {
    return this.http
      .get<MaestraCaracteristicas>(`${environment.baseUrl}MaestraCaracteristicas`)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllCausalInterrupcionSueno(): Observable<CausalInterrupcionSueno> {
    return this.http
      .get<CausalInterrupcionSueno>(environment.baseUrl + 'CausalInterrupcionSueno')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllConfiguracionUsuarioGeneral(): Observable<ConfiguracionUsuarioGeneral> {
    return this.http
      .get<ConfiguracionUsuarioGeneral>(environment.baseUrl + 'ConfiguracionUsuarioGeneral')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllConfiguracionUsuarioDistrito(): Observable<ConfiguracionUsuarioDistrito> {
    return this.http
      .get<ConfiguracionUsuarioDistrito>(environment.baseUrl + 'ConfiguracionUsuarioDistrito')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllConfiguracionUsuarioZonas(): Observable<ConfiguracionUsuarioZonas> {
    return this.http
      .get<ConfiguracionUsuarioZonas>(environment.baseUrl + 'ConfiguracionUsuarioZonas')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllCaracteristicasViviendaById(id: number): Observable<CaracteristicasVivienda> {
    return this.http
      .get<CaracteristicasVivienda>(environment.baseUrl + 'CaracteristicasVivienda/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllCaracteristicasById(id: number): Observable<MaestraCaracteristicas> {
    return this.http
      .get<MaestraCaracteristicas>(environment.baseUrl + 'MaestraCaracteristicas/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  // Consulta de registros de areas con parametros
  getAllCausalInterrupcionSuenoById(id: number): Observable<CausalInterrupcionSueno> {
    return this.http
      .get<CausalInterrupcionSueno>(environment.baseUrl + 'CausalInterrupcionSueno/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllCausalNoIngresosById(id: number): Observable<CausalNoIngresos> {
    return this.http
      .get<CausalNoIngresos>(environment.baseUrl + 'CausalNoIngresos/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  // Consulta de registros de areas con parametros
  getAllConfiguracionUsuarioDistritoById(id: number): Observable<ConfiguracionUsuarioDistrito> {
    return this.http
      .get<ConfiguracionUsuarioDistrito>(environment.baseUrl + 'ConfiguracionUsuarioDistrito/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllConsentimientoGSById(id: number): Observable<ConsentimientoGS> {
    return this.http
      .get<ConsentimientoGS>(environment.baseUrl + 'ConsentimientoGS/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllTipoConfiguracionById(id: number): Observable<TipoConfiguracion> {
    return this.http
      .get<TipoConfiguracion>(environment.baseUrl + 'TipoConfiguracion/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  crearCaracteristicasVivienda(data: any): Observable<CaracteristicasVivienda> {
    return this.http
  ...
  // Creación de un nuevo registro en la tabla accion actual.
  crearCausalInterrupcionSueno(data: any): Observable<CausalInterrupcionSueno> {
    return this.http
  ...
  // Creación de un nuevo registro en la tabla accion actual.
  crearConfiguracionUsuarioGeneral(data: any): Observable<ConfiguracionUsuarioGeneral> {
    return this.http
  ...
  // Creación de un nuevo registro en la tabla accion actual.
  crearConfiguracionUsuarioDistrito(data: any): Observable<ConfiguracionUsuarioDistrito> {
    return this.http
  ...
  // Creación de un nuevo registro en la tabla accion actual.
  crearConfiguracionUsuarioZonas(data: any): Observable<ConfiguracionUsuarioZonas> {
    return this.http
  ...
  updateCaracteristicasVivienda(id: number, data: any): Observable<CaracteristicasVivienda> {
    return this.http
  ...
  // Edición de registros existentes.
  updateCaracteristicas(id: number, data: any): Observable<MaestraCaracteristicas> {
    return this.http
  ...
  // Edición de registros existentes.
  updateCausalInterrupcionSueno(id: number, data: any): Observable<CausalInterrupcionSueno> {
    return this.http
  ...
  // Edición de registros existentes.
  updateCausalNoIngresos(id: number, data: any): Observable<CausalNoIngresos> {
    return this.http
  ...
  // Edición de registros existentes.
  updateConfiguracionUsuarioGeneral(id: number, data: any): Observable<ConfiguracionUsuarioGeneral> {
    return this.http
  ...
  // Edición de registros existentes.
  updateConfiguracionUsuarioDistrito(id: number, data: any): Observable<ConfiguracionUsuarioDistrito> {
    return this.http
  ...
  // Edición de registros existentes.
  updateConfiguracionUsuarioZonas(id: number, data: any): Observable<ConfiguracionUsuarioZonas> {
    return this.http
  ...
  // Edición de registros existentes.
  updateConsentimientosGS(id: number, data: any): Observable<ConsentimientoGS> {
    return this.http
  ...
  // Edición de registros existentes.
  updateTipoConfiguracion(id: number, data: any): Observable<TipoConfiguracion> {
    return this.http
  ...
  deleteCaracteristicasViviendaById(id: number): Observable<CaracteristicasVivienda> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteCausalInterrupcionSuenoById(id: number): Observable<CausalInterrupcionSueno> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteConfiguracionUsuarioGeneralById(id: number): Observable<ConfiguracionUsuarioGeneral> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteConfiguracionUsuarioDistritoById(id: number): Observable<ConfiguracionUsuarioDistrito> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteConfiguracionUsuarioZonasById(id: number): Observable<ConfiguracionUsuarioZonas> {
    return this.http
