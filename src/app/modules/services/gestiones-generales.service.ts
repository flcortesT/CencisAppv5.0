...
export class GestionesGeneralesService {
    ...
    getAllEjecucionGestionAC_GestionAdministrativa(): Observable<EjecucionGestionAC_GestionAdministrativa> {
        return this.http
            .get<EjecucionGestionAC_GestionAdministrativa>(
    ...
    getAllGestionActividadComplementaria(): Observable<GestionActividadComplementaria> {
        return this.http
            .get<GestionActividadComplementaria>(
    ...
    getAllEjecucionGestionAC_GestionGenerica(): Observable<EjecucionGestionAC_GestionGenerica> {
        return this.http
            .get<EjecucionGestionAC_GestionGenerica>(
    ...
    getAllEjecucionGestionACCapacitacion(): Observable<EjecucionGestionACCapacitacion> {
        return this.http
            .get<EjecucionGestionACCapacitacion>(
    ...
    getAllEjecucionGestionACClinicaCaracteristicasVivienda(): Observable<EjecucionGestionACClinicaCaracteristicasVivienda> {
        return this.http
            .get<EjecucionGestionACClinicaCaracteristicasVivienda>(
                environment.baseUrl +
    ...
    getAllEjecucionGestionACClinicaEnfermedades(): Observable<EjecucionGestionACClinicaEnfermedades> {
        return this.http
            .get<EjecucionGestionACClinicaEnfermedades>(
                environment.baseUrl + 'EjecucionGestionACClinicaEnfermedades'
            )
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    getAllEjecucionGestionACClinicaEventosAdversos(): Observable<EjecucionGestionACClinicaEventosAdversos> {
        return this.http
            .get<EjecucionGestionACClinicaEventosAdversos>(
    ...
    getAllEjecucionGestionACClinicaTemasEducacion(): Observable<EjecucionGestionACClinicaTemasEducacion> {
        return this.http
            .get<EjecucionGestionACClinicaTemasEducacion>(
    ...
    getAllEjecucionGestionACClinicaValidaciones(): Observable<EjecucionGestionACClinicaValidaciones> {
        return this.http
            .get<EjecucionGestionACClinicaValidaciones>(
    ...
    getAllEspecialidadesxMedicamento(): Observable<EspecialidadesxMedicamento> {
        return this.http
            .get<EspecialidadesxMedicamento>(
    ...
    getAllEjecucionGestionAC_GestionAdministrativaById(
        id: number
    ): Observable<EjecucionGestionAC_GestionAdministrativa> {
        return this.http
            .get<EjecucionGestionAC_GestionAdministrativa>(
                environment.baseUrl +
    ...
    // Consulta de registros de areas con parametros
    getAllGestionActividadComplementariaById(
        id: number
    ): Observable<GestionActividadComplementaria> {
        return this.http
            .get<GestionActividadComplementaria>(
    ...
    // Consulta de registros de areas con parametros
    getAllEjecucionGestionAC_GestionGenericaById(
        id: number
    ): Observable<EjecucionGestionAC_GestionGenerica> {
        return this.http
            .get<EjecucionGestionAC_GestionGenerica>(
    ...
    // Consulta de registros de areas con parametros
    getEjecucionGestionACApoyoById(
        id: number
    ): Observable<EjecucionGestionACApoyo> {
        return this.http
            .get<EjecucionGestionACApoyo>(
    ...
    // Consulta de registros de areas con parametros
    getEjecucionGestionACCapacitacionById(
        id: number
    ): Observable<EjecucionGestionACCapacitacion> {
        return this.http
            .get<EjecucionGestionACCapacitacion>(
    ...
    // Consulta de registros de areas con parametros
    getEjecucionGestionACClinicaById(
        id: number
    ): Observable<EjecucionGestionACClinica> {
        return this.http
            .get<EjecucionGestionACClinica>(
    ...
    // Consulta de registros de areas con parametros
    getEjecucionGestionACClinicaCaracteristicasViviendaById(
        id: number
    ): Observable<EjecucionGestionACClinicaCaracteristicasVivienda> {
        return this.http
            .get<EjecucionGestionACClinicaCaracteristicasVivienda>(
                environment.baseUrl +
                    'EjecucionGestionACClinicaCaracteristicasVivienda/' +
    ...
    // Consulta de registros de areas con parametros
    getEjecucionGestionACClinicaEnfermedadesById(
        id: number
    ): Observable<EjecucionGestionACClinicaEnfermedades> {
        return this.http
            .get<EjecucionGestionACClinicaEnfermedades>(
                environment.baseUrl + 'TipoAccesoVivienda/' + id
            )
    ...
    // Consulta de registros de areas con parametros
    getEjecucionGestionACClinicaEventosAdversosById(
        id: number
    ): Observable<EjecucionGestionACClinicaEventosAdversos> {
        return this.http
            .get<EjecucionGestionACClinicaEventosAdversos>(
                environment.baseUrl +
    ...
    // Consulta de registros de areas con parametros
    getEjecucionGestionACClinicaTemasEducacionById(
        id: number
    ): Observable<Enfermedades> {
        return this.http
            .get<Enfermedades>(environment.baseUrl + 'Enfermedades/' + id)
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    // Consulta de registros de areas con parametros
    getEjecucionGestionACClinicaValidacionesById(
        id: number
    ): Observable<EjecucionGestionACClinicaValidaciones> {
        return this.http
            .get<EjecucionGestionACClinicaValidaciones>(
                environment.baseUrl +
    ...
    // Consulta de registros de areas con parametros
    getEspecialidadesxMedicamentoById(
        id: number
    ): Observable<EspecialidadesxMedicamento> {
        return this.http
            .get<EspecialidadesxMedicamento>(
    ...
    getEstadoReporteFVById(id: number): Observable<EstadoReportesFV> {
        return this.http
            .get<EstadoReportesFV>(
                environment.baseUrl + 'EstadoReporteFV/' + id
            )
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    // Consulta de registros de areas con parametros
    getEventoAdversoSeguimientoById(
        id: number
    ): Observable<EventoAdversoSeguimiento> {
        return this.http
            .get<EventoAdversoSeguimiento>(
    ...
    crearEjecucionGestionAC_GestionAdministrativa(
        data: any
    ): Observable<EjecucionGestionAC_GestionAdministrativa> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearGestionActividadComplementaria(
        data: any
    ): Observable<GestionActividadComplementaria> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearEjecucionGestionAC_GestionGenerica(
        data: any
    ): Observable<EjecucionGestionAC_GestionGenerica> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearEjecucionGestionACCapacitacion(
        data: any
    ): Observable<EjecucionGestionACCapacitacion> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearEjecucionGestionACClinica(
        data: any
    ): Observable<EjecucionGestionACClinica> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearEjecucionGestionACClinicaCaracteristicasVivienda(
        data: any
    ): Observable<EjecucionGestionACClinicaCaracteristicasVivienda> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearEjecucionGestionACClinicaEnfermedades(
        data: any
    ): Observable<EjecucionGestionACClinicaEnfermedades> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearEjecucionGestionACClinicaEventosAdversos(
        data: any
    ): Observable<EjecucionGestionACClinicaEventosAdversos> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearEjecucionGestionACClinicaTemasEducacion(
        data: any
    ): Observable<EjecucionGestionACClinicaTemasEducacion> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearEjecucionGestionACClinicaValidaciones(
        data: any
    ): Observable<EjecucionGestionACClinicaValidaciones> {
        return this.http
    ...
    // Creación de un nuevo registro en la tabla accion actual.
    crearEspecialidadesxMedicamento(
        data: any
    ): Observable<EspecialidadesxMedicamento> {
        return this.http
    ...
    updateEjecucionGestionAC_GestionAdministrativa(
        id: number,
        data: any
    ): Observable<EjecucionGestionAC_GestionAdministrativa> {
        return this.http
    ...
    // Edición de registros existentes.
    updateGestionACAsignados(
        id: number,
        data: any
    ): Observable<GestionACAsignados> {
        return this.http
    ...
    // Edición de registros existentes.
    updateGestionActividadComplementaria(
        id: number,
        data: any
    ): Observable<GestionActividadComplementaria> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEjecucionGestionAC_GestionGenerica(
        id: number,
        data: any
    ): Observable<EjecucionGestionAC_GestionGenerica> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEjecucionGestionACCapacitacion(
        id: number,
        data: any
    ): Observable<EjecucionGestionACCapacitacion> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEjecucionGestionACClinica(
        id: number,
        data: any
    ): Observable<EjecucionGestionACClinica> {
        return this.http
    ...
    // Edición de registros existentes.
    updateGestionACGestion(
        id: number,
        data: any
    ): Observable<GestionACGestion> {
        return this.http
    ...
    // Edición de registros existentes.
    updateNivelEscolaridad(
        id: number,
        data: any
    ): Observable<NivelEscolaridad> {
        return this.http
    ...
    // Edición de registros existentes.
    updateTipoZonaVivienda(
        id: number,
        data: any
    ): Observable<TipoZonaVivienda> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEjecucionGestionACClinicaCaracteristicasVivienda(
        id: number,
        data: any
    ): Observable<EjecucionGestionACClinicaCaracteristicasVivienda> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEjecucionGestionClinicaEnfermedades(
        id: number,
        data: any
    ): Observable<EjecucionGestionACClinicaEnfermedades> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEjecucionGestionACClinicaEventosAdversos(
        id: number,
        data: any
    ): Observable<EjecucionGestionACClinicaEventosAdversos> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEjecucionGestionACClinicaTemasEducacion(
        id: number,
        data: any
    ): Observable<EjecucionGestionACClinicaTemasEducacion> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEjecucionGestionACClinicaValidaciones(
        id: number,
        data: any
    ): Observable<EjecucionGestionACClinicaValidaciones> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEntidadesMedicamento(
        id: number,
        data: any
    ): Observable<EntidadesMedicamento> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEspecialidesxMedicamento(
        id: number,
        data: any
    ): Observable<EspecialidadesxMedicamento> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEsquemasAplicacion(
        id: number,
        data: any
    ): Observable<EsquemasAplicacion> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEstadoAutorizacion(
        id: number,
        data: any
    ): Observable<EstadoAutorizacion> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEstadoGestionSocial(
        id: number,
        data: any
    ): Observable<EstadoGestionSocial> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEstadoReportesFV(
        id: number,
        data: any
    ): Observable<EstadoReportesFV> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEstadoSeguimientoFV(
        id: number,
        data: any
    ): Observable<EstadoSeguimientoFV> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEstadoxMedicamento(
        id: number,
        data: any
    ): Observable<EstadoxMedicamento> {
        return this.http
    ...
    // Edición de registros existentes.
    updateEventoAdversoSeguimiento(
        id: number,
        data: any
    ): Observable<EventoAdversoSeguimiento> {
        return this.http
    ...
    deleteEjecucionGestionAC_GestionAdministrativaById(
        id: number
    ): Observable<EjecucionGestionAC_GestionAdministrativa> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteGestionActividadComplementariaById(
        id: number
    ): Observable<GestionActividadComplementaria> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteEjecucionGestionAC_GestionGenericaById(
        id: number
    ): Observable<EjecucionGestionAC_GestionGenerica> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteEjecucionGestionACApoyoById(
        id: number
    ): Observable<EjecucionGestionACApoyo> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteEjecucionGestionACCapacitacionById(
        id: number
    ): Observable<EjecucionGestionACCapacitacion> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteEjecucionGestionACClinicaById(
        id: number
    ): Observable<EjecucionGestionACClinica> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteEjecucionGestionACClinicaCaracteristicasViviendaById(
        id: number
    ): Observable<EjecucionGestionACClinicaCaracteristicasVivienda> {
        return this.http
            .delete<EjecucionGestionACClinicaCaracteristicasVivienda>(
                environment.baseUrl +
                    'EjecucionGestionACClinicaCarcteristicasVivienda/' +
                    id,
                this.httpOptions
            )
            .pipe(retry(1), catchError(this.errorHandl));
    ...
    // Eliminar registro de la tabla ciudad
    deleteEjecucionGestionACClinicaEnfermedadesById(
        id: number
    ): Observable<EjecucionGestionACClinicaEnfermedades> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteEjecucionGestionACClinicaEventosAdversosById(
        id: number
    ): Observable<EjecucionGestionACClinicaEventosAdversos> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteEjecucionGestionACClinicaTemasEducacionById(
        id: number
    ): Observable<EjecucionGestionACClinicaTemasEducacion> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteEjecucionGestionACClinicaValidacionesById(
        id: number
    ): Observable<EjecucionGestionACClinicaValidaciones> {
        return this.http
            .delete<EjecucionGestionACClinicaTemasEducacion>(
    ...
    // Eliminar registro de la tabla ciudad
    deleteEntidadesMedicamentoById(
        id: number
    ): Observable<EntidadesMedicamento> {
        return this.http
    ...
    deleteEpsById(id: number): Observable<EPS> {
        return this.http
            .delete<EPS>(environment.baseUrl + 'EPS/' + id, this.httpOptions)
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    // Eliminar registro de la tabla ciudad
    deleteEspecialidadesxMedicamentoById(
        id: number
    ): Observable<EspecialidadesxMedicamento> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteEventoAdversoSeguimientoById(
        id: number
    ): Observable<EventoAdversoSeguimiento> {
        return this.http
