...
import { DatosClinicos, DatosClinicosCimzia, DatosClinicosFirmagon, DatosClinicosMyalept, DatosClinicosSativex, DatosClinicosTestMG, DatosClinicosVimpat, Diagnosticos, Dosis, Especialidades, Frecuencia, PeriodoConvulsionesDia, PresentacionMedicamento, TratamientoAntiespastico, UsoPrevio } from '../Models/datosClinicos.model';
...
export class DatosClinicosService {
  ...
  getAllPresentacionMedicamento(): Observable<PresentacionMedicamento> {
    return this.http
      .get<PresentacionMedicamento>(environment.baseUrl + 'PresentacionMedicamento')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllDatosClinicosCimzia(): Observable<DatosClinicosCimzia> {
    return this.http
      .get<DatosClinicosCimzia>(environment.baseUrl + 'DatosClinicosCimzia')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllDatosClinicosFirmagon(): Observable<DatosClinicosFirmagon> {
    return this.http
      .get<DatosClinicosFirmagon>(environment.baseUrl + 'DatosClinicosFirmagon')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllDatosClinicosMyalept(): Observable<DatosClinicosMyalept> {
    return this.http
      .get<DatosClinicosMyalept>(environment.baseUrl + 'DatosClinicosMyalept')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllDatosClinicosSativex(): Observable<DatosClinicosSativex> {
    return this.http
      .get<DatosClinicosSativex>(environment.baseUrl + 'DatosClinicosSativex')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllDatosClinicosTestMG(): Observable<DatosClinicosTestMG> {
    return this.http
      .get<DatosClinicosTestMG>(environment.baseUrl + 'DatosClinicosTestMG')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllDatosClinicosVimpat(): Observable<DatosClinicosVimpat> {
    return this.http
      .get<DatosClinicosVimpat>(environment.baseUrl + 'DatosClinicosVimpat')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllPeriodoConvulsionesDia(): Observable<PeriodoConvulsionesDia> {
    return this.http
      .get<PeriodoConvulsionesDia>(environment.baseUrl + 'PeriodoConvulsionesDia')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllTratamientoAntiespatisco(): Observable<TratamientoAntiespastico> {
    return this.http
      .get<TratamientoAntiespastico>(environment.baseUrl + 'TratamientoAntiespastico')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  // Consulta de registros de areas con parametros
  getAllPresentacionMedicamentoById(id: number): Observable<PresentacionMedicamento> {
    return this.http
      .get<PresentacionMedicamento>(environment.baseUrl + 'PresentacionMedicamento/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllDatosClinicosCimziaById(id: number): Observable<DatosClinicosCimzia> {
    return this.http
      .get<DatosClinicosCimzia>(environment.baseUrl + 'DatosClinicosCimzia/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }

  // Consulta de registros de areas con parametros
  getAllDatosClinicosFirmagonById(id: number): Observable<DatosClinicosFirmagon> {
    return this.http
      .get<DatosClinicosFirmagon>(environment.baseUrl + 'DatosClinicosFirmagon/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }

  // Consulta de registros de areas con parametros
  getAllDatosClinicosMyaleptById(id: number): Observable<DatosClinicosMyalept> {
    return this.http
      .get<DatosClinicosMyalept>(environment.baseUrl + 'DatosClinicosMyalept/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }

  // Consulta de registros de areas con parametros
  getAllDatosClinicosSativexById(id: number): Observable<DatosClinicosSativex> {
    return this.http
      .get<DatosClinicosSativex>(environment.baseUrl + 'DatosClinicosSativex/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllDatosClinicosTestMGById(id: number): Observable<DatosClinicosTestMG> {
    return this.http
      .get<DatosClinicosTestMG>(environment.baseUrl + 'DatosClinicosTestMG/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllDatosClinicosVimpatById(id: number): Observable<DatosClinicosVimpat> {
    return this.http
      .get<DatosClinicosVimpat>(environment.baseUrl + 'DatosClinicosVimpat/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }

  // Consulta de registros de areas con parametros
  getAllPeriodoConvulsionesDiaById(id: number): Observable<PeriodoConvulsionesDia> {
    return this.http
      .get<PeriodoConvulsionesDia>(environment.baseUrl + 'PeriodoConvulsionesDia/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }

  // Consulta de registros de areas con parametros
  getAllTratamientoAntiespaticoById(id: number): Observable<TratamientoAntiespastico> {
    return this.http
      .get<TratamientoAntiespastico>(environment.baseUrl + 'TratamientoAntiespatico/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  // Creación de un nuevo registro en la tabla accion actual.
  crearPresentacionMedicamento(data: any): Observable<PresentacionMedicamento> {
    return this.http
  ...
  // Creación de un nuevo registro en la tabla accion actual.
  crearTratamientoAntiespastico(data: any): Observable<TratamientoAntiespastico> {
    return this.http
  ...
  // Edición de registros existentes.
  updatePresentacionMedicamento(id: number, data: any): Observable<PresentacionMedicamento> {
    return this.http
  ...
  // Edición de registros existentes.
  updateDatosClinicosCimzia(id: number, data: any): Observable<DatosClinicosCimzia> {
    return this.http
  ...
  // Edición de registros existentes.
  updateDatosClinicosFirmagon(id: number, data: any): Observable<DatosClinicosFirmagon> {
    return this.http
  ...
  // Edición de registros existentes.
  updateDatosClinicosMyalept(id: number, data: any): Observable<DatosClinicosMyalept> {
    return this.http
  ...
  // Edición de registros existentes.
  updateDatosClinicosSativex(id: number, data: any): Observable<DatosClinicosSativex> {
    return this.http
  ...
  // Edición de registros existentes.
  updateDatosClinicosTestMG(id: number, data: any): Observable<DatosClinicosTestMG> {
    return this.http
  ...
  // Edición de registros existentes.
  updateDatosClinicosVimpat(id: number, data: any): Observable<DatosClinicosVimpat> {
    return this.http
  ...
  // Edición de registros existentes.
  updatePeriodoConvulsionesDia(id: number, data: any): Observable<PeriodoConvulsionesDia> {
    return this.http
  ...
  // Edición de registros existentes.
  updateTratamientoAntiespastico(id: number, data: any): Observable<TratamientoAntiespastico> {
    return this.http
      .put<DatosClinicosVimpat>(
  ...
  // Eliminar registro de la tabla ciudad
  deletePresentacionMedicamentoById(id: number): Observable<PresentacionMedicamento> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteDatosClinicosFirmagonById(id: number): Observable<DatosClinicosFirmagon> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteDatosClinicosMyaleptById(id: number): Observable<DatosClinicosMyalept> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteDatosClinicosSativexById(id: number): Observable<DatosClinicosSativex> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteByPeriodoConvulsionesDiaId(id: number): Observable<PeriodoConvulsionesDia> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteTratamientoAntiespasticoById(id: number): Observable<TratamientoAntiespastico> {
    return this.http
