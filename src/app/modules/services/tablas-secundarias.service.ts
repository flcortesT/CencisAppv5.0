...
export class TablasSecundariasService {
  ...
  getAllTipoConfiguracionUsuario(): Observable<TipoConfiguracionUsuario> {
    return this.http
      .get<TipoConfiguracionUsuario>(environment.baseUrl + 'TipoConfiguracionUsuario/')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllTipoDosisxMedicamento(): Observable<TipoDosisxMedicamento> {
    return this.http
      .get<TipoDosisxMedicamento>(environment.baseUrl + 'TipoDosisxMedicamento/')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllTipoIdentificacionxPais(): Observable<TipoIdentificacionxPais> {
    return this.http
      .get<TipoIdentificacionxPais>(environment.baseUrl + 'TipoIdentificacionxPais/')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllTipoAccesoVehicular(): Observable<TipoAccesoVehicular> {
    return this.http
      .get<TipoAccesoVehicular>(environment.baseUrl + 'TipoAccesoVehicular/')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllUsoPrevioxMedicamento(): Observable<UsoPrevioxMedicamento> {
    return this.http
      .get<UsoPrevioxMedicamento>(environment.baseUrl + 'UsoPrevioxMedicamento/')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  // Consulta de registros de accion actual.
  getAllZonasCiudad(): Observable<ZonasCiudad> {
    return this.http
      .get<ZonasCiudad>(environment.baseUrl + 'ZonasCiudad/')
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  // Consulta de registros de areas con parametros
  getAllTipoConfiguracionUsuarioById(id: number): Observable<TipoConfiguracionUsuario> {
    return this.http
  ...
  // Consulta de registros de areas con parametros
  getAllTipoDosisxMedicamentoById(id: number): Observable<TipoDosisxMedicamento> {
    return this.http
      .get<TipoDosisxMedicamento>(environment.baseUrl + 'TipoDosisxMedicamento/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  // Consulta de registros de areas con parametros
  getAllTipoIdentificacionxPaisById(id: number): Observable<TipoIdentificacionxPais> {
    return this.http
      .get<TipoIdentificacionxPais>(environment.baseUrl + 'TipoIdentificacionxPais/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllTipoAccesoVehicularById(id: number): Observable<TipoAccesoVehicular> {
    return this.http
      .get<TipoAccesoVehicular>(environment.baseUrl + 'TipoAccesoVehicular/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllTipoVisualizacionById(id: number): Observable<TipoVisualizacion> {
    return this.http
      .get<TipoVisualizacion>(environment.baseUrl + 'TipoVisualizacion/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  // Consulta de registros de areas con parametros
  getAllUsoPrevioxMedicamentoById(id: number): Observable<UsoPrevioxMedicamento> {
    return this.http
      .get<UsoPrevioxMedicamento>(environment.baseUrl + 'UsoPrevioxMedicamento/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  getAllViaAdministracionById(id: number): Observable<ViaAdministracion> {
    return this.http
      .get<ViaAdministracion>(environment.baseUrl + 'ViaAdministracion/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  // Consulta de registros de areas con parametros
  getAllZonasCiudadById(id: number): Observable<ZonasCiudad> {
    return this.http
      .get<ZonasCiudad>(environment.baseUrl + 'ZonasCiudad/' + id)
      .pipe(retry(1), catchError(this.errorHandl));
  }
  ...
  // Creación de un nuevo registro en la tabla accion actual.
  crearTipoConfiguracionUsuario(data: any): Observable<TipoConfiguracionUsuario> {
    return this.http
  ...
  // Creación de un nuevo registro en la tabla accion actual.
  crearTipoIdentificacionxPais(data: any): Observable<TipoIdentificacionxPais> {
    return this.http
  ...
  // Creación de un nuevo registro en la tabla accion actual.
  crearZonasCiudad(data: any): Observable<ZonasCiudad> {
    return this.http
      .post<ZonasCiudad>(
  ...
  // Edición de registros existentes.
  updateTipoConfiguracionUsuario(id: number, data: any): Observable<TipoConfiguracionUsuario> {
    return this.http
  ...
  // Edición de registros existentes.
  updateTipoDosisxMedicamento(id: number, data: any): Observable<TipoDosisxMedicamento> {
    return this.http
  ...
  // Edición de registros existentes.
  updateTipoIdentificacionxPais(id: number, data: any): Observable<TipoIdentificacionxPais> {
    return this.http
  ...
  // Edición de registros existentes.
  updateTipoAccesoVehicular(id: number, data: any): Observable<TipoAccesoVehicular> {
    return this.http
  ...
  // Edición de registros existentes.
  updateTipoVisualizacion(id: number, data: any): Observable<TipoVisualizacion> {
    return this.http
  ...
  // Edición de registros existentes.
  updateUsoPrevioxMedicamento(id: number, data: any): Observable<UsoPrevioxMedicamento> {
    return this.http
  ...
  // Edición de registros existentes.
  updateViaAdministracion(id: number, data: any): Observable<ViaAdministracion> {
    return this.http
  ...
  // Edición de registros existentes.
  updateZonasCiudad(id: number, data: any): Observable<ZonasCiudad> {
    return this.http
      .put<ZonasCiudad>(
  ...
  // Eliminar registro de la tabla ciudad
  deleteTipoConfiguracionUsuarioById(id: number): Observable<TipoConfiguracionUsuario> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteTipoDosisxMedicamentoById(id: number): Observable<TipoDosisxMedicamento> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteTipoIdentificacionxPaisById(id: number): Observable<TipoIdentificacionxPais> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteUsoPrevioxMedicamentoById(id: number): Observable<UsoPrevioxMedicamento> {
    return this.http
  ...
  // Eliminar registro de la tabla ciudad
  deleteZonasCiudadById(id: number): Observable<ZonasCiudad> {
    return this.http
      .delete<ZonasCiudad>(
        environment.baseUrl + 'ZonasCiudad/' + id,
        this.httpOptions
