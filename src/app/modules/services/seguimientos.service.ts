...
export class SeguimientosService {
    ...
    getAllSeguimientoGestionSocialById(
        id: number
    ): Observable<SeguimientoGestionSocial> {
        return this.http
            .get<SeguimientoGestionSocial>(
    ...
    updateSeguimientoGestionSocial(
        id: number,
        data: any
    ): Observable<SeguimientoGestionSocial> {
        return this.http
    ...
    // Edición de registros existentes.
    updateSoporteInscripcion(
        id: number,
        data: any
    ): Observable<SoporteInscripcion> {
        return this.http
    ...
    // Edición de registros existentes.
    updateSoporteTratamiento(
        id: number,
        data: any
    ): Observable<SoporteTratamiento> {
        return this.http
    ...
    deleteSeguimientoGestionSocialById(
        id: number
    ): Observable<SeguimientoGestionSocial> {
        return this.http
    ...
    deleteSiNoById(id: number): Observable<SiNo> {
        return this.http
            .delete<SiNo>(environment.baseUrl + 'SiNo/' + id, this.httpOptions)
            .pipe(retry(1), catchError(this.errorHandl));
    }
