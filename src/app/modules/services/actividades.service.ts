...
export class ActividadesService {
    ...
    getAllAplicacionSeguimientoVitales(): Observable<AplicacionSeguimientoVitales> {
        return this.http
            .get<AplicacionSeguimientoVitales>(
    ...
    // Consulta de registros de areas con parametros
    getAllMaestraDatosClinicosById(
        id: number
    ): Observable<MaestraDatosClinicos> {
        return this.http
            .get<MaestraDatosClinicos>(
    ...
    // Consulta de registros de areas con parametros
    getAllAccionesxMedicamentoById(
        id: number
    ): Observable<AccionesxMedicamento> {
        return this.http
            .get<AccionesxMedicamento>(
    ...
    // Consulta de registros de areas con parametros
    getAllActividadComplementariaById(
        id: number
    ): Observable<ActividadComplementaria> {
        return this.http
            .get<ActividadComplementaria>(
    ...
    // Consulta de registros de areas con parametros
    getAllAplicacionSeguimientoById(
        id: number
    ): Observable<AplicacionSeguimiento> {
        return this.http
            .get<AplicacionSeguimiento>(
    ...
    // Consulta de registros de areas con parametros
    getAllAplicacionSeguimientoVitalesById(
        id: number
    ): Observable<AplicacionSeguimientoVitales> {
        return this.http
            .get<AplicacionSeguimientoVitales>(
    ...
    getAllEsquemaAplicacionById(id: number): Observable<EsquemaAplicacion> {
        return this.http
            .get<EsquemaAplicacion>(
                environment.baseUrl + 'EsquemaAplicacion/' + id
            )
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    // Creación de un nuevo registro en la tabla acciones.
    crearAplicacionSeguimientoVitales(
        data: any
    ): Observable<AplicacionSeguimientoVitales> {
        return this.http
    ...
    // Edición de registros existentes.
    updateAplicacionSeguimientoVitales(
        id: number,
        data: any
    ): Observable<AplicacionSeguimientoVitales> {
        return this.http
    ...
    // Edición de registros existentes.
    updateMaestraActividad(
        id: number,
        data: any
    ): Observable<MaestraActividad> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteAccionesxMedicamentoById(
        id: number
    ): Observable<AccionesxMedicamento> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteActividadComplementariaById(
        id: number
    ): Observable<ActividadComplementaria> {
        return this.http
    ...
    deleteSexoById(id: number): Observable<Sexo> {
        return this.http
            .delete<Sexo>(environment.baseUrl + 'Sexo/' + id, this.httpOptions)
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    // Eliminar registro de la tabla ciudad
    deleteAplicacionSeguimientoById(
        id: number
    ): Observable<AplicacionSeguimiento> {
        return this.http
    ...
    // Eliminar registro de la tabla ciudad
    deleteAplicacionSeguimientoVitalesById(
        id: number
    ): Observable<AplicacionSeguimientoVitales> {
        return this.http
    ...
    deleteIpsById(id: number): Observable<IPS> {
        return this.http
            .delete<IPS>(environment.baseUrl + 'Ips/' + id, this.httpOptions)
            .pipe(retry(1), catchError(this.errorHandl));
    }
    ...
    // Eliminar registro de la tabla ciudad
    deleteMaestraDatosClinicosById(
        id: number
    ): Observable<MaestraDatosClinicos> {
        return this.http
